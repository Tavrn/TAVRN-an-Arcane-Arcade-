namespace VRTK.Examples
{
    ...
    public class Duel_ControllerEvents_Listener : MonoBehaviour
    {
        ...
        private void DoTriggerPressed(object sender, ControllerInteractionEventArgs e)
        {
            ...
            colliders.GetComponent<CollidersScript>().JumpToWand();
            WandTip.GetComponent<WandScript>().setChanneling(true);
        }
        ...
        private void DoTriggerTouchEnd(object sender, ControllerInteractionEventArgs e)
        {
            ...
            WandTip.GetComponent<WandScript>().setChanneling(false);
        }
        ...
        private void DoGripPressed(object sender, ControllerInteractionEventArgs e)
        {
            ...
            // WandTip.GetComponent<WandScript>().FireSpell();
            spellManager.TryBeginAiming();
        }
